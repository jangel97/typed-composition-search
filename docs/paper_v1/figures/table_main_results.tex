...
Granite-8B & Kubernetes & 0.494 & 0.656 & 0.531 & 0.926 & 0.847 & 0.865 & +0.334 \\
 ...
 & CI/CD & 0.438 & 0.682 & 0.511 & 0.906 & 0.719 & 0.781 & +0.270 \\
 & Shopify & 0.632 & 0.849 & 0.686 & 0.927 & 0.903 & 0.901 & +0.215 \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Main results: Baseline (direct tool selection) vs.\ Graph (Typed Composition Routing) across all model--domain combinations. Graph routing improves F1 in all 20 combinations (avg.\ $\Delta$F1 = +0.323). All graph strategies produce zero hallucinated tools.}
