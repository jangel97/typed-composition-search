...
Section~\ref{sec:production-eval} demonstrates that automatic derivation from OpenAPI specifications is feasible for RESTful APIs with consistent naming conventions, but generalization to arbitrary API surfaces remains an open problem.

\paragraph{Entity Type System Quality.}

Even when a graph is available, the effectiveness of TCR depends on the granularity of the entity type system.
