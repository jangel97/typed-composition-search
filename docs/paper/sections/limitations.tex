...
TCR requires the graph to encode the semantic distinctions necessary for composition.
Benchmarks or domains whose type system is too coarse (e.g., only modality-level types) collapse distinct workflows into identical graph paths, preventing the graph from disambiguating tool sequences.
