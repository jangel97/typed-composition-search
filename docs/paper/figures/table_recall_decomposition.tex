...
Granite-8B & Kubernetes & 0.600 & 0.867 & 0.225 & 0.610 & 0.847 & 0.237 \\
 ...
 & CI/CD & 0.269 & 1.000 & 0.237 & 0.442 & 0.719 & 0.276 \\
 & Shopify & 0.655 & 0.947 & 0.367 & 0.747 & 0.903 & 0.156 \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Recall decomposition: $\hat{R} = P(\text{correct}) \cdot R_{\text{correct}} + P(\text{wrong}) \cdot R_{\text{wrong}}$. $R_{\text{wrong}}$ is consistently above zero (avg.\ 0.292, range 0.10--0.65): performance degrades gracefully under type prediction errors rather than collapsing.}
