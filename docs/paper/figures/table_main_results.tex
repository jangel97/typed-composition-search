...
\bottomrule
\end{tabular}
\caption{Main results: Baseline (direct tool selection) vs.\ Graph (typed composition search) across all model--domain combinations. Graph routing improves F1 in all 20 combinations (avg.\ $\Delta$F1 = +0.323). All graph strategies produce zero hallucinated tools.}
